...
export default function App(){
  ...
  async function addFamousCourse(course) {
    if (allCourses.some(c => c.name === course.name)) return;
    await saveCoursetoDB({ name: course.name, level: course.level, holes: course.holes, tournament: course.location || "" });
  }
