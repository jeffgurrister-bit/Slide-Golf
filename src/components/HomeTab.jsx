...
export default function HomeTab({
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <a href="https://www.amazon.com/dp/B0GK9C5VDF" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",display:"block"}}>
        <div style={{background:"linear-gradient(135deg,#1a2a1a,#2a3a2a)",borderRadius:12,padding:14,border:`1px solid ${C.gold}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,cursor:"pointer"}}>
          <div style={{minWidth:0,flex:1}}>
            <div style={{fontSize:11,color:C.gold,textTransform:"uppercase",letterSpacing:2,fontWeight:600}}>Love Slide Golf?</div>
            <div style={{fontSize:14,fontWeight:700,color:C.text,marginTop:2}}>Get your own set on Amazon</div>
            <div style={{fontSize:10,color:C.muted,marginTop:2}}>Skill-based tabletop sliding game</div>
          </div>
          <div style={{background:"#FF9900",color:"#0F1111",fontWeight:700,padding:"8px 14px",borderRadius:6,fontSize:12,whiteSpace:"nowrap"}}>🛒 Buy Now</div>
        </div>
      </a>
    </div>
  );
